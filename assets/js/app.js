...
addEventOnElements($tabBtns, "keydown", function (e) {
  const $nextElement = this.nextElementSibling; /* NodeElement */
  const $previousElement = this.previousElementSibling; /* NodeElement */
...
let apiUrl = "https://api.github.com/users/adilaben";
let repoUrl,
  followerUrl,
  followingUrl = "";
...
`.repeat(6);
  ...
  fetchData(
    ...
    (data) => {
      ...
      <div class="footer">
        <p class="copyright">
          &copy; 2023 <a href="https://www.adilaben.com/" class="text-primary">adilaben</a>
        </p>
      </div>
    `;
...
const updateForkRepo = function () {
  ...
  if (forkedRepos.length) {
    for (const repo of forkedRepos) {
      ...
      const /*{NodeElemet}*/ $forkCard = document.createElement("article");
